...
const questions = [
  {
    ...
    options: ["Hyderabad", "Mumbai", "Bengaluru", "Pune"],
    correct: 2,
  },
  {
    id: 2,
        ...
        <div style={{ flex: 1, minWidth: "280px", padding: "32px 24px" }}>
          ...
          <div
            ...
            <div
              ...
              <button
                onClick={toggleFlag}
                style={{
                  background: flagged.includes(current)
                    ? "rgba(245,158,11,0.1)"
                    : "#1e293b",
                  border: flagged.includes(current)
                    ? "1px solid #f59e0b"
                    : "1px solid #334155",
          ...
          <div
            ...
            <button
              ...
              style={{
                background:
                  current === questions.length - 1 ? "#1e293b" : "#0ea5e9",
                border: "none",
                color: "white",
                padding: "10px 24px",
                borderRadius: "10px",
        ...
        <div
          ...
          <div
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <span
                style={{ color: "#94a3b8", fontWeight: 700, fontSize: "12px" }}>
