            ...
            <div key={user.rank}>
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  borderBottom:
                    index < filteredOthers.length - 1
                      ? "1px solid #1e293b"
                      : "none",
                  background: (user as any).isYou
                ...
                <div
                  ...
                  <span
                    style={{
                      ...
                      fontSize: "14px",
                      fontWeight: (user as any).isYou ? 700 : 500,
                    }}>
                    {user.name}
                  </span>
                  {(user as any).isYou && (
        ...
        <div
          ...
          <div>
            <div style={{ color: "white", fontWeight: 700, fontSize: "15px" }}>
              ...
              <span style={{ color: "#38bdf8" }}>#142</span>
            </div>
            <div
              style={{ color: "#475569", fontSize: "13px", marginTop: "2px" }}>
